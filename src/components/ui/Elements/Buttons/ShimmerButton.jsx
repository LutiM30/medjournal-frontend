...
const ShimmerButton = React.forwardRef(({ className, ...props }, ref) => {
  ...
  const buttonClasses = cn(
    'inline-flex text-sm md:text-xs sm:text-[0.7rem] h-14 md:h-12 sm:h-10 xs:h-8 animate-shimmer items-center justify-center',
    'border rounded-full px-8 md:px-6 sm:px-4 xs:px-1.5 font-medium transition-colors',
