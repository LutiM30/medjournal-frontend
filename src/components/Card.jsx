...
const authors = [
    {
        ...
        backgroundImage: "/images/aboutus-bg-mitul.jpg"
    },
    {
        ...
        backgroundImage: "/images/aboutus-bg-aarti.jpg"
    },
    {
        ...
        backgroundImage: "/images/aboutus-bg-dhruvin.jpg"
    },
    {
                    ...
                    {authors.map((author, index) => (
                        <div key={index}
                            ...
                            <div
                                ...
                                className="cursor-pointer overflow-hidden relative card h-96 rounded-md shadow-xl mx-auto flex flex-col justify-between p-4 bg-cover bg-center"
