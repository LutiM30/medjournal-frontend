...
export function DoctorsListCard() {
    const cards = data.map((card, index) => (
        <Card key={card.src} card={card} index={index} className="object-cover" layout={true} />
    ));
...
const data = [
    {
        ...
        content: <DummyContent src="https://firebasestorage.googleapis.com/v0/b/capstone-bd303.appspot.com/o/Doctors%2Fjonathanborba-15770389.jpg?alt=media&token=b4b91e5f-02a2-45d5-aed4-31b780e92f6c" availability="Monday - Friday: 10 AM - 5 PM, Weekends: Off" />,
    },
    {
        ...
        content: <DummyContent src="https://firebasestorage.googleapis.com/v0/b/capstone-bd303.appspot.com/o/Doctors%2Fmikhail-nilov-28123672.jpg?alt=media&token=43903ace-e1f9-4030-a7e5-0128b52387d9" availability="Weekends: 11 AM - 1 PM, Weekdays: Off" />,
    },
    {
        ...
        content: <DummyContent src="https://firebasestorage.googleapis.com/v0/b/capstone-bd303.appspot.com/o/Doctors%2Fshvetsa-3902881.jpg?alt=media&token=543d4e22-a9a2-4cae-9c46-3045aff3af5e" availability="Monday - Friday: 10 AM - 5 PM, Weekends: Off" />,
    },

    {
        ...
        content: <DummyContent src="https://firebasestorage.googleapis.com/v0/b/capstone-bd303.appspot.com/o/Doctors%2Ftessy-agbonome-521343232-18828741.jpg?alt=media&token=a8c83aa4-7a1d-4927-af78-0dd7bd1d4907" availability="Weekends: 11 AM - 1 PM, Weekdays: Off" />,
    },
    {
        ...
        content: <DummyContent src="https://firebasestorage.googleapis.com/v0/b/capstone-bd303.appspot.com/o/Doctors%2Fthirdman-5327585.jpg?alt=media&token=3e19785f-e05a-4d44-8973-ecd8ac291766" availability="Monday - Friday: 10 AM - 5 PM, Weekends: Off" />,
    },
    {
        ...
        content: <DummyContent src="https://firebasestorage.googleapis.com/v0/b/capstone-bd303.appspot.com/o/Doctors%2Fjeff-denlea-721292-3714743.jpg?alt=media&token=8bb99685-0dff-48a4-afcd-60fc6c353655" availability="Weekends: 11 AM - 1 PM, Weekdays: Off" />,
    },
];
