...
const ProfileCard = () => {
    return (
        <div className="profile-card card p-6 mb-6 bg-gradient-to-r from-blue-50 to-blue-100 shadow-lg rounded-lg text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-xl border-l-4 border-blue-500">
            ...
            <h2 className="text-2xl font-bold text-blue-700 transition-colors duration-300 hover:text-blue-600">Dr. John Czaja</h2>
            <p className="text-lg text-gray-600 mb-1">Specialty: <span className="text-blue-500 font-semibold">Cardiology</span></p>
