...
const UpcomingAppointments = () => {
  ...
  //     timeSlot: 'Monday, October 9, 2024 - 10:00 AM - 10:30 AM',
  //   },
  //   {
  //     id: 2,
  //     patientName: 'Jane Smith',
  //     comment: 'Follow-up consultation',
  //     timeSlot: 'Wednesday, October 11, 2024 - 2:00 PM - 2:30 PM',
  //   },
  //   {
  //     id: 3,
  //     patientName: 'Emily Clark',
  //     comment: 'Annual physical exam',
  //     timeSlot: 'Friday, October 13, 2024 - 9:00 AM - 9:30 AM',
  //   },
  // ]);
  const [appointments, setAppointments] = useState([]);
  ...
  //       return {
  //         ...appointment,
  //         timeSlot: `${formattedDate} - ${selectedTime} - ${endTime}`,
  //       };
  //     }
  //     return appointment;
  //   });
