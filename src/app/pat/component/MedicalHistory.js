...
const MedicalHistory = () => {
    return (
        <div className="mb-6 p-6 border border-blue-400 dark:bg-slate-900 rounded-lg shadow-lg bg-blue-50 transition-transform duration-300 hover:shadow-xl">
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <p className="text-white-700">Hypertension, Diabetes</p>
                </div>
                <div>
                    <label className="font-medium">Past Surgeries and Dates:</label>
                    <p className="text-white-700">Appendectomy - 2015</p>
                </div>
                <div>
                    <label className="font-medium">Allergies:</label>
                    <p className="text-white-700">Penicillin, Peanuts</p>
                </div>
                <div>
                    <label className="font-medium">Current Medications:</label>
                    <p className="text-white-700">Metformin 500mg, Lisinopril 20mg</p>
                </div>
            </div>
        </div>
    );
